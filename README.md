# Cybersecurity Foundations Lab: Offensive vs Defensive Security
...
- Exploitation in proper and authorized lab environments
- Reporting on findings responsibly

## 3. Defensive Security
Defensive security, meanwhile, focuses on protecting systems, detecting attacks, and responding to any incidents.
They monitor networks, review alerts, patch vulnerabilities, configure firewalls, and investigate suspicious activity.
...
|---|---|---|
| Goal | Find weaknesses | Protect systems |
| Team | Red Team | Blue Team |
| Main Work | Testing, exploitation, reporting | Monitoring, patching, responding |
